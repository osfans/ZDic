...
extern Err ZDicDBInitDictList(UInt32 type, UInt32 creator, Int16* dictCount);
extern Err ZDicDBInitIndexRecord(void);
extern Err ZDicOpenCurrentDict(void);
extern Err ZDicCloseCurrentDict(void);
extern Err ZDicDBInitShortcutList(void);
extern Err ZDicDBInitPopupList(void);
